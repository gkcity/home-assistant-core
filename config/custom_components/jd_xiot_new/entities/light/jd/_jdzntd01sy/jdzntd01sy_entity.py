...
from xiot_core_device_controller.jd._light._jdzntd01sy.device_jdzntd01sy import (
    DeviceJdzntd01sy,
)
...
# ------------------------------
@register_light_entity
class DeviceJdzntd01syEntity(LightEntity):
    """DeviceJdzntd01sy Entity."""

    TYPE: str = DeviceJdzntd01sy.TYPE
    ...
    def __init__(
        ...
        self._device: DeviceJdzntd01sy | None = None
