...
from xiot_core_device_controller.jd._light._jdznxtd02sy.device_jdznxtd02sy import (
    DeviceJdznxtd02sy,
)
...
# ------------------------------
@register_light_entity
class DeviceJdznxtd02syEntity(LightEntity):
    """DeviceJdznxtd02sy Entity."""

    TYPE: str = DeviceJdznxtd02sy.TYPE
    ...
    def __init__(
        ...
        self._device: DeviceJdznxtd02sy | None = None
        ...
        if isinstance(controller, DeviceJdznxtd02sy):
            self._device: DeviceJdznxtd02sy = controller
