...
from xiot_core_device_controller.jd._light._jdznsd02sy.device_jdznsd02sy import (
    DeviceJdznsd02sy,
)
...
# ------------------------------
@register_light_entity
class DeviceJdznsd02syEntity(LightEntity):
    """DeviceJdznsd02sy Entity."""

    TYPE: str = DeviceJdznsd02sy.TYPE
    ...
    def __init__(
        ...
        self._device: DeviceJdznsd02sy | None = None
        ...
        if isinstance(controller, DeviceJdznsd02sy):
            self._device: DeviceJdznsd02sy = controller
