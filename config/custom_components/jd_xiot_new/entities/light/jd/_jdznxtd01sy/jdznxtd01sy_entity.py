...
from custom_components.jd_xiot_new.entities.light.jd_light_mapping import (
    register_light_entity,
)
from xiot_core.support.typedef.controller.device_controller import DeviceController
from xiot_core_device_controller.jd._light._jdznxtd01sy.device_jdznxtd01sy import (
    DeviceJdznxtd01sy,
)
...
# ------------------------------
@register_light_entity
class DeviceJdznxtd01syEntity(LightEntity):
    """DeviceJdznxtd01sy Entity."""

    TYPE: str = DeviceJdznxtd01sy.TYPE
    ...
    def __init__(
        ...
        self._device: DeviceJdznxtd01sy | None = None
        ...
        if isinstance(controller, DeviceJdznxtd01sy):
            self._device: DeviceJdznxtd01sy = controller
