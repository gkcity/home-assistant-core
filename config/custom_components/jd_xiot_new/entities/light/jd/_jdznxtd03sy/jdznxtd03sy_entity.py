...
from xiot_core_device_controller.jd._light._jdznxtd03sy.device_jdznxtd03sy import (
    DeviceJdznxtd03sy,
)
...
# ------------------------------
@register_light_entity
class DeviceJdznxtd03syEntity(LightEntity):
    """DeviceJdznxtd03sy Entity."""

    TYPE: str = DeviceJdznxtd03sy.TYPE
    ...
    def __init__(
        ...
        self._device: DeviceJdznxtd03sy | None = None
