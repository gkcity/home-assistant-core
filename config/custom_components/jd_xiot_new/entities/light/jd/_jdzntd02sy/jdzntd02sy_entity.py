...
from xiot_core_device_controller.jd._light._jdzntd02sy.device_jdzntd02sy import (
    DeviceJdzntd02sy,
)
...
# ------------------------------
@register_light_entity
class DeviceJdzntd02syEntity(LightEntity):
    """DeviceJdzntd02sy Entity."""

    TYPE: str = DeviceJdzntd02sy.TYPE
    ...
    def __init__(
        ...
        self._device: DeviceJdzntd02sy | None = None
        ...
        if isinstance(controller, DeviceJdzntd02sy):
            self._device: DeviceJdzntd02sy = controller
