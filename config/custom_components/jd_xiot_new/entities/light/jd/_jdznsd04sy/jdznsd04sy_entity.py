...
from xiot_core_device_controller.jd._light._jdznsd04sy.device_jdznsd04sy import (
    DeviceJdznsd04sy,
)
...
# ------------------------------
@register_light_entity
class DeviceJdznsd04syEntity(LightEntity):
    """DeviceJdznsd04sy Entity."""

    TYPE: str = DeviceJdznsd04sy.TYPE
    ...
    def __init__(
        ...
        self._device: DeviceJdznsd04sy | None = None
        ...
        if isinstance(controller, DeviceJdznsd04sy):
            self._device: DeviceJdznsd04sy = controller
