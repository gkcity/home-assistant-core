...
#     def __init__(self, api: JingDongXiotApi, device_info: JoyDeviceDetail, controller: DeviceController) -> None:
...
#         self._attr_name: str = device_info.get("additional", {}).get("name", self._device_id)
