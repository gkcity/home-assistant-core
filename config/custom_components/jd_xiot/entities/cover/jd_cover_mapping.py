"""Cover mapping for DeviceController."""
...
_entities: dict[str, type[CoverEntity]] = {}


def register_cover_entity(cls):
    """注册灯光实体类到实体注册表中.
...
def create_cover_entity(
    ...
    _LOGGER.info("Create Cover Entity: %s (entities: %d)", device_type, len(_entities))
