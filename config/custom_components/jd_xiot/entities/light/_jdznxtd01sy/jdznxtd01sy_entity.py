...
from xiot_core_device_controller.jd._light._jdznxtd01sy.jdznxtd01sy import Jdznxtd01sy
...
# ------------------------------
@register_light_entity
class Jdznxtd01syEntity(LightEntity):
    """Jdznxtd01sy Entity."""

    TYPE: str = Jdznxtd01sy.TYPE
    ...
    def __init__(
        ...
        self._device: Jdznxtd01sy | None = None
        ...
        if isinstance(controller, Jdznxtd01sy):
            self._device: Jdznxtd01sy = controller
