...
from xiot_core_device_controller.jd._light._jdznxtd03sy.jdznxtd03sy import Jdznxtd03sy
...
# ------------------------------
@register_light_entity
class Jdznxtd03syEntity(LightEntity):
    """Jdznxtd03sy Entity."""

    TYPE: str = Jdznxtd03sy.TYPE
    ...
    def __init__(
        ...
        self._device: Jdznxtd03sy | None = None
        ...
        if isinstance(controller, Jdznxtd03sy):
            self._device: Jdznxtd03sy = controller
