...
from xiot_core_device_controller.jd._light._jdzntd01sy.jdzntd01sy import Jdzntd01sy
...
# ------------------------------
@register_light_entity
class Jdzntd01syEntity(LightEntity):
    """Jdzntd01sy Entity."""

    TYPE: str = Jdzntd01sy.TYPE
    ...
    def __init__(
        ...
        self._device: Jdzntd01sy | None = None
        ...
        if isinstance(controller, Jdzntd01sy):
            self._device: Jdzntd01sy = controller
