...
from xiot_core_device_controller.jd._light._jdznsd03sy.jdznsd03sy import Jdznsd03sy
...
# ------------------------------
@register_light_entity
class Jdznsd03syEntity(LightEntity):
    """Jdznsd03sy Entity."""

    TYPE: str = Jdznsd03sy.TYPE
    ...
    def __init__(
        ...
        self._device: Jdznsd03sy | None = None
        ...
        if isinstance(controller, Jdznsd03sy):
            self._device: Jdznsd03sy = controller
