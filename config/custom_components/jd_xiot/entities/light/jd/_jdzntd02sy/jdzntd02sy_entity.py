...
from xiot_core_device_controller.jd._light._jdzntd02sy.jdzntd02sy import Jdzntd02sy
...
# ------------------------------
@register_light_entity
class Jdzntd02syEntity(LightEntity):
    """Jdzntd02sy Entity."""

    TYPE: str = Jdzntd02sy.TYPE
    ...
    def __init__(
        ...
        self._device: Jdzntd02sy | None = None
        ...
        if isinstance(controller, Jdzntd02sy):
            self._device: Jdzntd02sy = controller
