...
from xiot_core_device_controller.jd._light._jdznsd04sy.jdznsd04sy import Jdznsd04sy
...
# ------------------------------
@register_light_entity
class Jdznsd04syEntity(LightEntity):
    """Jdznsd04sy Entity."""

    TYPE: str = Jdznsd04sy.TYPE
    ...
    def __init__(
        ...
        self._device: Jdznsd04sy | None = None
        ...
        if isinstance(controller, Jdznsd04sy):
            self._device: Jdznsd04sy = controller
