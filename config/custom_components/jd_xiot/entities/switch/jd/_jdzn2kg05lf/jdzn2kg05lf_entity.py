...
from xiot_core_device_controller.jd._switch._jdzn2kg05lf.jdzn2kg05lf import Jdzn2kg05lf
...
@register_switch_entity
class Jdzn2kg05lfEntity1(SwitchEntity):
    """Jdzn2kg05lf Entity(1)."""

    TYPE: str = Jdzn2kg05lf.TYPE
    ...
    def __init__(
        ...
        self._device: Jdzn2kg05lf | None = None
        ...
        if isinstance(controller, Jdzn2kg05lf):
            self._device: Jdzn2kg05lf = controller
...
@register_switch_entity
class Jdzn2kg05lfEntity2(SwitchEntity):
    """Jdzn2kg05lf Entity(2)."""
