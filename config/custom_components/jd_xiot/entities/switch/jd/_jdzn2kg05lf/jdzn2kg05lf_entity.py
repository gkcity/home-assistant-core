...
from xiot_core_device_controller.jd._switch._jdzn2kg05lf.device_jdzn2kg05lf import (
    DeviceJdzn2kg05lf,
)
...
@register_switch_entity
class DeviceJdzn2kg05lfEntity1(SwitchEntity):
    """DeviceJdzn2kg05lf Entity(1)."""

    TYPE: str = DeviceJdzn2kg05lf.TYPE
...
@register_switch_entity
class DeviceJdzn2kg05lfEntity2(SwitchEntity):
    """DeviceJdzn2kg05lf Entity(2)."""
